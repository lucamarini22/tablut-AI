...
public class GameStateImpl implements GameState{
    ...
    private static final LinkedList<Integer> WHITE_POS = new LinkedList<Integer>(Arrays.asList(2, 3, 5, 6));
    private static final LinkedList<Integer> BLACK_EDGES_1 = new LinkedList<Integer>(Arrays.asList(3, 4, 5));
    private static final LinkedList<Integer> BLACK_EDGES_2 = new LinkedList<Integer>(Arrays.asList(0, 8));
